...
## Filename
Name files with `dash-case`. E.g. `my-control.component.ts`, `string-formatter.ts`, `map.ts` etc.

> Reason: Not conventional across many JS teams, but is the convention for Angular projects.
...
### Thanks to basarat for the original styleguide
